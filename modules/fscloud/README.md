...
| <a name="input_revocation_threshold"></a> [revocation\_threshold](#input\_revocation\_threshold) | The number of administrator signatures required to remove an administrator after you leave imprint mode. Only used if auto\_initialization\_using\_recovery\_crypto\_units is true | `number` | `1` | no |
...
| <a name="input_signature_threshold"></a> [signature\_threshold](#input\_signature\_threshold) | The number of administrator signatures required to execute administrative commands. Only used if auto\_initialization\_using\_recovery\_crypto\_units is true | `number` | `1` | no |
